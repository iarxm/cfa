...
# bar {
#   status_command exec /home/iao/.config/i3status/mybar.sh
# }

bg_bar_color="#282A36"
bg_seperator_previous="#0000000"
# Print a left caret separator
# @params {string} $1 text color, ex: "#FF0000"
# @params {string} $2 background color, ex: "#FF0000"

separator() {
# personal mod - removed triangle powerline figure
  echo -n "{"
...
mycrypto() {
  ...
  export bg_separator_previous=$bg
  echo -n ",{"
  echo -n "\"name\":\"id_crypto\","
  echo -n "\"full_text\":\" $(/home/iao/.config/i3status/crypto.py) \","
  echo -n "\"color\":\"#000000\","
...
myvpn_on() {
  ...
  separator $bg $bg_seperator_previous
  export bg_separator_previous=$bg
  #"#1976D2" # background left previous block
  echo -n ",{"
  echo -n "\"name\":\"id_vpn\","      
...
#  local bg="#000000"
  separator $bg $bg_seperator_previous
#  export $bg_seperator_previous=$bg
  #"#FFD180"
  echo -n ",{"
  echo -n "\"name\":\"ip_public\","
  echo -n "\"full_text\":\" $(/home/iao/.config/i3status/ip.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
disk_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/iao/.config/i3status/disk.py)%\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
memory() {
  ...
  echo -n "\"full_text\":\"  $(/home/iao/.config/i3status/memory.py)%\","
...
cpu_usage() {
  ...
  echo -n "\"full_text\":\"  $(/home/iao/.config/i3status/cpu.py)% \","
  echo -n "\"background\":\"#3949AB\","
  common
  echo -n "},"
}
...
meteo() {
  ...
  echo -n "\"full_text\":\" $(/home/iao/.config/i3status/meteo.py) \","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
}
...
mydate() {
  ...
  echo -n ",{"
  echo -n "\"name\":\"id_time\","
  echo -n "\"full_text\":\" $(date "+%jw%V md%d %H:%M") \","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
...
battery0() {
  if [ -f /sys/class/power_supply/BAT1/uevent ]; then
    ...
    echo -n "\"full_text\":\" ${icon} $(/home/iao/.config/i3status/i3-power-status) \","
...
pomoo() {
  ...
  echo -n ",{"
  echo -n "\"name\":\"id_time\","
  echo -n "\"full_text\":\" $(/home/iao/.local/bin/i3pomo) \","
  echo -n "\"color\":\"#000000\","
  echo -n "\"background\":\"$bg\","
  common
  echo -n "},"
...
do
  ...
  # TIME
    ...
    alacritty -e /home/iao/.config/i3status/click_time.sh &

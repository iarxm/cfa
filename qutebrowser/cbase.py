...
config.bind('<Alt-j>',              'run-with-count 15 scroll down', mode='normal')
config.bind('<Alt-k>',              'run-with-count 15 scroll up', mode='normal')
config.bind('<Alt-j>',              'run-with-count 10 scroll down', mode='normal')
...
config.bind('b',            'set-cmd-text -s :bk', mode='normal')
config.bind('p',            'set-cmd-text -s :pdf', mode='normal')
config.bind('se',           ':set-cmd-text -s :session-load', mode='normal')
config.bind('sl',           ':set-cmd-text -s :session-load', mode='normal')
config.bind('sw',           ':set-cmd-text -s :session-save', mode='normal')
config.bind('sr',           ':set-cmd-text -s :session-delete', mode='normal')
